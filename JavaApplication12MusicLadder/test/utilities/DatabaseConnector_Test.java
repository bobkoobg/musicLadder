...
public class DatabaseConnector_Test {
    ...
    @Test
    public void test_getConnection_WithLogger_success() {
    ...
    @Test
    public void test_getConnection_WithLogger_failure() {
        PerformanceLogger performanceLogger = new PerformanceLogger();
        Logger logger = performanceLogger.initLogger( loggerName, loggerPath );
    ...
    @Test
    public void test_getConnection_otherJDBCDriver_WithLogger_success() {
        PerformanceLogger performanceLogger = new PerformanceLogger();
        Logger logger = performanceLogger.initLogger( loggerName, loggerPath );
    ...
    @Test
    public void test_getConnection_otherJDBCDriver_WithLogger_failure() {
        PerformanceLogger performanceLogger = new PerformanceLogger();
        Logger logger = performanceLogger.initLogger( loggerName, loggerPath );
    ...
    @Test
    public void test_getConnection_otherJDBCDriver_WithLogger_failure2() {
        PerformanceLogger performanceLogger = new PerformanceLogger();
        Logger logger = performanceLogger.initLogger( loggerName, loggerPath );
    ...
    @Test
    public void test_closeConnection_WithLogger_failure() {
        PerformanceLogger performanceLogger = new PerformanceLogger();
        Logger logger = performanceLogger.initLogger( loggerName, loggerPath );
        ...
        dbConnection = new DatabaseConnector( databaseHost, databaseUsername, databasePassword, "" );
        Connection connection = dbConnection.getConnection( logger );
        boolean isConnectionClosed = dbConnection.closeConnection( connection, logger );
