...
public class DuelGenerator {
    ...
    public <T> T generator( List<Song> songs ) {
        ...
        List<Integer> songProbabilityPool = generateSongProbabilityPool( songs );
    ...
    private List<Integer> generateSongProbabilityPool( List<Song> songs ) {
